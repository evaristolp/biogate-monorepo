      ...
      <div className="mx-auto max-w-[1200px]">
        ...
        <div ref={colsRef} className="reveal grid gap-px border border-[#1E1F23] bg-[#1E1F23] md:grid-cols-2">
          ...
          <div className="bg-[#090909] p-8 md:p-10">
            <p className="text-[10px] font-medium uppercase tracking-[0.2em] text-[#C9A96E] mb-6">
              What we are
            </p>
          ...
          <div className="bg-[#090909] p-8 md:p-10 md:border-l border-[#1E1F23]">
            <p className="text-[10px] font-medium uppercase tracking-[0.2em] text-[#585858] mb-6">
              What we are not
            </p>
            <ul className="space-y-7">
              {weAreNot.map((item) => (
